...
public class App {
    public static void main(String[] args) throws Exception {
        String cheminTxt = "C://Users/PANGNON/Documents/Projet MSPR DevMSPR-dev/MSPR-dev/sauvegarde/jmacclane.txt";

        // Le chmemin vers la page html à modifier
        File HtmlFile = new File("C://Users/PANGNON/Documents/Projet MSPR DevMSPR-dev/MSPR-dev/SiteWeb/jmacclane.html");
        ...
        String kit = Files.readAllLines(Paths.get(cheminTxt)).get(5);
        String outil1 = Files.readAllLines(Paths.get(cheminTxt)).get(6);
        String outil2 = Files.readAllLines(Paths.get(cheminTxt)).get(7);
        ...
        if (!HtmlFile.exists()) {
            ...
            List<String> htmlLines = Arrays.asList("<!DOCTYPE html> <html>" +
                    ...
                    " <div id='icones'>" +
                    " <img src='C:/Users/PANGNON/Documents/Projet MSPR DevMSPR-dev/MSPR-dev/SiteWeb/images/JeanMacclaneID.jpg' alt='ID' class='imageIcone'>"
                    +
                    "  </div>  " +
