...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        String cheminTxt = "C://Users/PANGNON/Documents/Projet MSPR DevMSPR-dev/MSPR-dev/sauvegarde/mriggs.txt";

        // Le chmemin vers la page html à modifier
        File HtmlFile = new File("C://Users/PANGNON/Documents/Projet MSPR DevMSPR-dev/MSPR-dev/SiteWeb/mriggs.html");
        ...
        if (!HtmlFile.exists()) {
            ...
            List<String> htmlLines = Arrays.asList("<!DOCTYPE html> <html>" +
                    ...
                    " <div id='icones'>" +
                    " <img src='C:/Users/PANGNON/Documents/Projet MSPR DevMSPR-dev/MSPR-dev/SiteWeb/images/MariaRiggsID.jpg' alt='ID' class='imageIcone'>"
                    +
                    "  </div>  " +
